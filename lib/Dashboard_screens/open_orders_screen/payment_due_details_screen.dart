...
import 'package:lezof_auto_repair_mobile_app/Dashboard_screens/open_orders_screen/save_payment_method_screen.dart';
...
class PaymentDueDetailScreen extends StatefulWidget {
  const PaymentDueDetailScreen({super.key});

  @override
  State<PaymentDueDetailScreen> createState() => _PaymentDueDetailScreenState();
}

class _PaymentDueDetailScreenState extends State<PaymentDueDetailScreen> {
          ...
          child: SizedBox(
            ...
            child: Center(
              child: utils.registerButton(
                  ...
                  radius: 30.0,
                  onTap: () {
                    Go.to(context, const SavePaymentMethod());
                  },
                  textColor: white,
                  buttonColor: primary,
                  borderColor: primary),
